...
def sets_piece_lists():
    ...
    for set_data in sets_list:
        ...
        set_message = set_id + ": " + json.loads(response.text)["meta"]["message"]
        print(set_message)
        ...
        for piece_user in pieces_list_user:
            ...
            for piece_json in pieces_list_json:
                ...
                if piece_json_color != piece_user_color:
                    ...
                    print(piece_user_id + " with color " + piece_user_color + " found in " + set_id)
                ...
                if piece_json_quantity < piece_user_quantity:
                    ...
                    print(piece_user_id + " with color " + piece_user_color + " with <= " + piece_user_quantity + " found in " + set_id)
